<section class="cmbcore-page-block cmbcore-page-block--cta" @if(!empty($props['background_image'])) style="background-image: url('{{ theme_media_url((string) $props['background_image']) }}')" @endif>
    <div class="cmbcore-page-block__inner cmbcore-page-block__inner--centered">
